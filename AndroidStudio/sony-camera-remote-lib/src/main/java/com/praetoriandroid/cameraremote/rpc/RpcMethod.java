...
public enum RpcMethod {
    ...
    startLiveview, // +
    stopLiveview, // +
    startLiveviewWithSize, getLiveviewSize, getAvailableLiveviewSize, getSupportedLiveviewSize,
    ...
    setExposureMode, getExposureMode, getAvailableExposureMode, getSupportedExposureMode, setExposureCompensation, getExposureCompensation, getAvailableExposureCompensation, getSupportedExposureCompensation,
