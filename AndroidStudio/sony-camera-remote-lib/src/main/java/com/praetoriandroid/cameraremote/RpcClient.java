...
public class RpcClient {
    ...
    public void sayHello() throws RpcException {
        ...
        if (!appInfo.isVersionOk()) {
            throw new RpcException("Illegal camera API version (must be at least 2.0.0): " + appInfo.getVersion());
        }
    ...
    public <Response extends BaseResponse<?>> Response send(BaseRequest<?, Response> request) throws RpcException {
        try {
