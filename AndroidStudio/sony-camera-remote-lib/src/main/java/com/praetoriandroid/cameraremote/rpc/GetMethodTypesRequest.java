...
public class GetMethodTypesRequest extends BaseRequest<String, GetMethodTypesResponse> {
    ...
    private Gson createGson() {
        return new GsonBuilder().registerTypeAdapter(MethodTypesEntity.class, new MethodTypesEntityDeserializer()).create();
    }
    ...
    private static class MethodTypesEntityDeserializer implements JsonDeserializer<MethodTypesEntity> {
        ...
        @Override
        public MethodTypesEntity deserialize(JsonElement json, Type typeOfT, JsonDeserializationContext context) throws JsonParseException {
            try {
                if (!json.isJsonArray()) {
