...
public class ZeroTopPaddingTextView extends TextView {
    ...
    private static final Typeface SAN_SERIF__CONDENSED_BOLD = Typeface.create("sans-serif-condensed", Typeface.BOLD);
    ...
    public void updatePadding() {
        ...
        if (getTypeface() == null) {
            androidClockMonoThin = Typeface.createFromAsset(getContext().getAssets(), "fonts/AndroidClockMono-Thin.ttf");
...
//                    getTypeface().equals(SAN_SERIF__CONDENSED_BOLD)) {
        ...
        // height in px
        setPadding(0, (int) (-paddingRatio * getTextSize()), mPaddingRight, (int) (-bottomPaddingRatio * getTextSize()));
    }
