...
public class ArcProgress extends View {
    ...
    private void init(Context context, AttributeSet attrs, int defStyle) {
        ...
        if (attrs != null) {
            ...
            final TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.ArcProgress, defStyle, 0);
            mProgress = a.getInteger(R.styleable.ArcProgress_progress, mProgress);
            mStartAngle = a.getInteger(R.styleable.ArcProgress_startAngle, mStartAngle);
            mEndAngle = a.getInteger(R.styleable.ArcProgress_endAngle, mEndAngle);
            mProgressWidth = a.getDimension(R.styleable.ArcProgress_progressWidth, mProgressWidth);
    ...
    public void setProgress(int progress) {
        ...
        if (mClockwise) {
            ...
            PropertyValuesHolder drawArc = PropertyValuesHolder.ofInt("endProgress", mEndProgressAngle, newEndProgress);
            ...
            PropertyValuesHolder drawArc = PropertyValuesHolder.ofInt("endProgress", mEndProgressAngle, newEndProgress);
            PropertyValuesHolder startAngle = PropertyValuesHolder.ofInt("startProgress", mStartProgressAngle, newStartProgress);
