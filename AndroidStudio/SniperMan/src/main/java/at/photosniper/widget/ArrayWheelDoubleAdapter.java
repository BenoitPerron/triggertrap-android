...
public class ArrayWheelDoubleAdapter extends AbstractWheelTextAdapter {
    ...
    public ArrayWheelDoubleAdapter(Context context, List<String> mNdValues, String[] subs) {
        super(context);
    ...
    public View getItem(int index, View convertView, ViewGroup parent) {
        if (index >= 0 && index < getItemsCount()) {
            if (convertView == null) {
                convertView = getView(R.layout.wheel_double_text_centered, parent);
            }
            ...
            TextView subTextView = (TextView) convertView.findViewById(R.id.text2);
            if (subTextView != null) {
