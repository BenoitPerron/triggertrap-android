...
public class TimerView extends LinearLayout implements DialpadManager.DialPadInput {
    ...
    public long getTime() {
        long secs = mInput[7] * 36000 + mInput[6] * 3600 + mInput[5] * 600 + mInput[4] * 60 + mInput[3] * 10 + mInput[2];
    ...
    public void setTextInputTime(long time) {
        ...
        setTime(hoursTens, hoursUnits, minTens, minUnits, (int) seconds, (int) hundreds);
    }
    ...
    private void updateTime() {
        setTime(mInput[7], mInput[6], mInput[5], mInput[4], mInput[3] * 10 + mInput[2], mInput[1] * 10 + mInput[0]);
    }
