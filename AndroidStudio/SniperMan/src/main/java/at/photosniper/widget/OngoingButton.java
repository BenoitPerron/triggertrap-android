...
public class OngoingButton extends View {
    ...
    private void init(Context context, AttributeSet attrs, int defStyle) {
        ...
        if (attrs != null) {
            ...
            final TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.OnGoingButton, defStyle, 0);
    ...
    private void setUpAnimations() {
        if (mFirstCircleAnimator == null) {
            ...
            PropertyValuesHolder pvhFirstCircleRadius = PropertyValuesHolder.ofFloat("firstCircleRadius", mStartCircleRadius, mFinalCircleRadius);
            PropertyValuesHolder pvhFirstCircleAlpha = PropertyValuesHolder.ofFloat("firstCircleAlpha", 125, 0);
            PropertyValuesHolder pvhFirstCircleStroke = PropertyValuesHolder.ofFloat("firstCircleStroke", DEFAULT_OUTER_WIDTH, (DEFAULT_OUTER_WIDTH * 2));
            ...
            PropertyValuesHolder pvhThirdCircleRadius = PropertyValuesHolder.ofFloat("thirdCircleRadius", mThirdCircleStartRadius, mStartCircleRadius);
            PropertyValuesHolder pvhthirdCircleAlpha = PropertyValuesHolder.ofFloat("thirdCircleAlpha", 0, 255);
