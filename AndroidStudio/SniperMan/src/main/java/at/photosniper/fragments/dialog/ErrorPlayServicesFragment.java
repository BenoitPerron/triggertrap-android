...
public class ErrorPlayServicesFragment extends SimpleDialogFragment {
    ...
    public void show(Activity activity) {
        new ErrorPlayServicesFragment().show(activity.getFragmentManager(), "error_play_services");
    }

    @Override
    public BaseDialogFragment.Builder build(BaseDialogFragment.Builder builder) {
        builder.setView(LayoutInflater.from(getActivity()).inflate(R.layout.running_action_dialog, null));
        builder.setTitle(getResources().getString(R.string.google_play_error_title));
        builder.setMessage(getResources().getString(R.string.google_play_error_description));
