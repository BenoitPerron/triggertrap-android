...
public class EmailUsDialogFrag extends SimpleDialogFragment {
    ...
    public BaseDialogFragment.Builder build(BaseDialogFragment.Builder builder) {
        ...
        builder.setPositiveButton(getResources().getString(R.string.send_email), new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                dismiss();
                Intent emailIntent = new Intent(Intent.ACTION_SENDTO, Uri.fromParts("mailto", "hello@at.the.gogo.photosniper.com", null));
                startActivity(Intent.createChooser(emailIntent, getResources().getString(R.string.send_email)));
            }
        });

        builder.setNegativeButton(getResources().getString(R.string.to_play_negative), new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                dismiss();
            }
