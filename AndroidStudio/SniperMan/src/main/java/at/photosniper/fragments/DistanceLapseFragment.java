...
public class DistanceLapseFragment extends PhotoSniperBaseFragment {
    ...
    public void onAttach(Activity activity) {
        ...
        try {
            ...
            throw new ClassCastException(activity.toString() + " must implement DistanceLapseListener");
        }
    }
    ...
    private void setUpButton() {
        mButton = (OngoingButton) mRootView.findViewById(R.id.distanceLapseButton);
    ...
    public void onDistanceLapseUpdate(float distanceTraveled, float speed) {
        ...
        int distanceRemaining = (mDistanceTrigger - (int) mDistanceTraveled);
    ...
    public interface DistanceLapseListener {
        void onStartDistanceLapse(int distance);

        void onStopDistanceLapse();

    }

    public interface GooglePlayServiceState {
        int SERVICE_AVAILABLE = 0;
        int SERVICE_NOT_AVAILABLE = 1;
    }
