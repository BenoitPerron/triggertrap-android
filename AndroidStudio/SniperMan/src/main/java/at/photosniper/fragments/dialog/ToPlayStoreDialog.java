...
public class ToPlayStoreDialog extends SimpleDialogFragment {
    ...
    public BaseDialogFragment.Builder build(BaseDialogFragment.Builder builder) {
        ...
        builder.setNeutralButton(R.string.to_play_neutral, new View.OnClickListener() {
        ...
        builder.setNegativeButton(R.string.to_play_negative, new View.OnClickListener() {
