...
public class AlertErrorDialog extends SimpleDialogFragment {
    ...
    public void show(Activity activity) {
        new AlertErrorDialog().show(activity.getFragmentManager(), "alert_error");
    }
    ...
    public BaseDialogFragment.Builder build(BaseDialogFragment.Builder builder) {
        ...
        builder.setTitle(getResources().getString(R.string.google_play_error_title)).setMessage(getResources().getString(R.string.google_play_error_description));
