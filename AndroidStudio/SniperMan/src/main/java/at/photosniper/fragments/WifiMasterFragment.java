...
public class WifiMasterFragment extends TriggertrapFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        mSlaveListLayout = (LinearLayout) mRootView.findViewById(R.id.wifi_slave_list);

        mMasterInfoView = (LinearLayout) mRootView.findViewById(R.id.slaceInfoView);
...
//		});
    ...
    private void onClickCheckBox(View checkBoxView) {
        ...
        mClickedCheckBox = (CheckBox) checkBoxParent.findViewById(R.id.wifi_slave_check_box);
    ...
    public void onClientDisconnected(String name, String uniqueName) {
        ...
        if (mSlaveListLayout.getChildCount() < 1) {
            getActivity().getLayoutInflater().inflate(R.layout.wifi_slave_item_empty, mSlaveListLayout, true);
        }
    ...
    private void createSlaveView(String name, String uniqueName) {
        ...
        View slaveItem = getActivity().getLayoutInflater().inflate(R.layout.wifi_slave_item, mSlaveListLayout, false);
        ...
        CheckBox checkBox = (CheckBox) slaveItem.findViewById(R.id.wifi_slave_check_box);
        ...
        View noDevicesView = mSlaveListLayout.findViewWithTag(getResources().getString(R.string.no_devices_found));
        ...
        switch (requestCode) {
            case DIALOG_FRAGMENT:
                if (resultCode == Activity.RESULT_OK) {
                    ...
                    Log.d(TAG, "Disconnecting from master... " + mClickedcheckBoxInfo.name);
                    if (mlistener != null) {
    ...
    public interface WifiMasterListener {
        ...
        void onStartWifiMaster();

        void onStopWifiMaster();

        void onDisconnectSlaveFromMaster(String uniqueName);
    }
