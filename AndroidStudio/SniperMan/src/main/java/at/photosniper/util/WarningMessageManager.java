...
public class WarningMessageManager {
    ...
    public WarningMessageManager(Context ctx, View messageView) {
        ...
        mSlideInFromBottom = (AnimationSet) AnimationUtils.loadAnimation(mContext, R.anim.show_warning_message);
        mSlideInFromBottom.setInterpolator(new OvershootInterpolator(4.0f));
        mSlideOutToBottom = AnimationUtils.loadAnimation(mContext, R.anim.slide_out_to_bottom);
    ...
    public void startListening() {
        ...
        LocalBroadcastManager.getInstance(mContext).registerReceiver(mMessageReceiver, new IntentFilter(ACTION));
    }
