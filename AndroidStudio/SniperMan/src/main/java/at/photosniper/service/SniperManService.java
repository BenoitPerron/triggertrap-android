...
//        ,PebbleController.PebbleTriggerListener
{
    ...
    public void onCreate() {
        ...
        BitmapDrawable iconDrawable = (BitmapDrawable) this.getResources().getDrawable(R.drawable.tt_nofication_large);
        ...
        mNotificationBuilder = new Notification.Builder(this).setContent(mRemoteViews).setTicker("Triggertrap", mRemoteViews).setSmallIcon(R.drawable.notification_icon);
    ...
    public void goToForeground() {
        ...
        // Android
        this.startForeground(R.string.tt_foreground_service_started, mNotificationBuilder.getNotification());
    ...
    private void upDateNotification(long millisUntilFinished) {
        if (mIsRunningInForeground && mPowerManager.isScreenOn()) {
            ...
            // mNotificationBuilder.setContentText(notificationText);
            mRemoteViews.setCharSequence(R.id.notificationDescription, "setText", notificationText);
            mNotificationManager.notify(R.string.tt_foreground_service_started, mNotificationBuilder.getNotification());
